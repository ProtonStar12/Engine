...
def modified_euler_method(initial_y,h_value,end_point,f):
    ...
    while x_value < end_point:
        ...
        # Calculate K2
        K2 = h_value * parsed_eq.subs({x: x_value + h_value/2, y: y_value + K1/2})
        # Calculate the next y-value using modified euler
        y_next = y_value + K2
        # Print the values
